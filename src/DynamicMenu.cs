...
namespace ConsoleApplication
{
    public static class DynamicMenu
    {
        ...
        public static string[] filesMenu = {"Create file", "Delete file", "Move file", "Rename File", "Read text from file", "Write text to file", "Search file for text", "Open file", "Return to MAIN MENU"};
